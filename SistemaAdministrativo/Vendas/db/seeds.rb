User.create name: 'Larah', status: :active, kind: :salesman, email: 'salesman@teste.com', password: 123456
User.create name: 'Larissa', status: :active, kind: :salesman, email: 'salesman2@teste.com', password: 123456
User.create name: 'Suellen', status: :active, kind: :manager, email: 'manager@teste.com', password: 123456
